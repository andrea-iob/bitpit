...
namespace bitpit {
    ...
    */
    ...
    ParaTree::loadBalance(dvector* weight){
        loadBalance<DummyDataLBInterface>(nullptr, weight);
    }
    ...
    ParaTree::loadBalance(uint8_t & level, dvector* weight){
        loadBalance<DummyDataLBInterface>(nullptr, level, weight);
    };
    ...
    ParaTree::privateLoadBalance(uint32_t* partition){
        privateLoadBalance<DummyDataLBInterface>(nullptr, partition);
    }
#endif
