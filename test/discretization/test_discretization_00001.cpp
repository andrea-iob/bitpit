...
int subtest_001()
{
    ...
    // Test linear reconstruction
    {
        ...
        reconstruction.computePointGradientWeights(reconstructionOrigin, point, pointGradientStencil.weightData());
...
int subtest_003()
{
    ...
    // Generate reconstruction
    {
        ...
        Reconstruction reconstruction(2, dimensions);
        int nCoeffs = reconstruction.countCoefficients();
        ...
        std::vector<double> evaluatedCoeffs(nCoeffs);
        reconstruction.computePolynomialCoeffs(pointValues.data(), evaluatedCoeffs.data());

        log::cout() << " Expected polynomial coefficients:  " << expectedCoeffs << std::endl;
        log::cout() << " Evaluated polynomial coefficients: " << evaluatedCoeffs << std::endl;
...
int subtest_004()
{
    ...
    // Generate reconstruction stencil
    {
        ...
        reconstruction.computePointValueWeights(reconstructionOrigin, point, pointValueStencil.weightData());
        ...
        reconstruction.computePointDerivativeWeights(reconstructionOrigin, point, direction, pointDerivativeStencil.weightData());
